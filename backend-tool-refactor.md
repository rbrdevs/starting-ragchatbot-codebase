Refactor @backend/ai_generator.py to support sequential tool callin where Claude cand make up to 2 tool calls in separate API rounds.
...
- Support for complex queries requiriing multiple searches for comparisons, multi-part questions, or when information from different courses/lessons is needed.
...
- Preserve conversation contex between rounds
