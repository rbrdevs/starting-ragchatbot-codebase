...
class TestRAGSystem:
    ...
    def test_query_with_tools(self, rag_system):
        ...
        rag_system.tool_manager.get_tool_definitions = MagicMock(
    ...
    def test_tool_registration(self, test_config, mock_components):
        ...
        with patch("rag_system.ToolManager") as mock_tool_manager_class:
            ...
            assert (
                mock_tool_manager.register_tool.call_count >= 2
            )  # At least search and outline tools
    ...
    def test_add_course_folder_skip_duplicates(
        self, rag_system, sample_course, sample_course_chunks
    ):
